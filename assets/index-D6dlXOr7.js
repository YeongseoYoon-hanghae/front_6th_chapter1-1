(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e){if(t.type!==`childList`)continue;for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();const e=()=>{let e=new Set,t=t=>{e.add(t)},n=t=>{e.delete(t)},r=(...t)=>{e.forEach(e=>e(...t))};return{subscribe:t,unsubscribe:n,notify:r}},t=t=>{let{subscribe:n,notify:r}=e(),i=()=>window.location.pathname,a=()=>{let e=i();if(t[e])return t[e];for(let[n,r]of Object.entries(t))if(n.includes(`:`)){let t=n.split(`/`),i=e.split(`/`);if(t.length===i.length){let e=t.every((e,t)=>e.startsWith(`:`)||e===i[t]);if(e)return r}}return null},o=e=>{window.history.pushState(null,null,e),r()};return window.addEventListener(`popstate`,()=>r()),{get path(){return i()},push:o,subscribe:n,getTarget:a,routes:t}},n={value:null,get(){return this.value},set(e){this.value=e}},r=e=>{n.get().push(e)},i=()=>{let e=window.location.pathname,t=n.get();if(!t||!t.routes)return{};for(let[n]of Object.entries(t.routes))if(n.includes(`:`)){let t=n.split(`/`),r=e.split(`/`);if(t.length===r.length){let e=t.every((e,t)=>e.startsWith(`:`)||e===r[t]);if(e){let e={};return t.forEach((t,n)=>{if(t.startsWith(`:`)){let i=t.slice(1);e[i]=r[n]}}),e}}}return{}},a={},o=e=>{let t=e.type,n=a[t];if(n){for(let t in n)if(e.target.matches(t)||e.target.closest(t)){n[t](e);break}}},s=(()=>{let e=!1;return()=>{if(e)return;let t=[`click`,`change`,`input`,`submit`,`focus`,`blur`];t.forEach(e=>{document.addEventListener(e,o,!0)}),e=!0}})(),c=(e,t,n)=>{a[e]||(a[e]={}),a[e][t]=n,Object.keys(a[e]).length===1&&document.addEventListener(e,o,!0)},l=()=>`
