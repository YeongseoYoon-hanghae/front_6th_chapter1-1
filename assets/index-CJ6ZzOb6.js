...
`;let T=null,E=null,he=!1;function D(){let e=document.querySelector(`#root`);if(!e){console.warn(`Root element (#root) not found`);return}try{let t=l.get(),n=t.getTarget()??me,r=t.path,i=typeof n==`function`?n():n.render?.()||``;e.innerHTML=i,!he&&typeof C.mount==`function`&&(C.mount(),he=!0),r!==T&&(T&&E&&typeof E.unmount==`function`&&E.unmount(),typeof n.mount==`function`&&(n.mount(),E=n),T=r)}catch(t){console.error(t),e.innerHTML=me()}ee()}const ge=e=>`
