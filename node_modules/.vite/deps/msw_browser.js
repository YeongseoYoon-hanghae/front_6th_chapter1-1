import { DeferredPromise, Interceptor, RequestHandler, SetupApi, createRequestId, devUtils, getTimestamp, handleRequest, invariant, onUnhandledRequest, toPublicUrl } from "./handleRequest-C7eirNfa.js";

//#region node_modules/.pnpm/msw@2.10.2/node_modules/msw/lib/core/utils/toResponseInit.mjs
...
//#endregion
//#region node_modules/.pnpm/msw@2.10.2/node_modules/msw/lib/core/utils/internal/isHandlerKind.mjs
...
//#endregion
//#region node_modules/.pnpm/msw@2.10.2/node_modules/msw/lib/core/utils/internal/isObject.mjs
function isObject$1(value) {
	return value != null && typeof value === "object" && !Array.isArray(value);
}

//#endregion
//#region node_modules/.pnpm/msw@2.10.2/node_modules/msw/lib/core/utils/internal/mergeRight.mjs
...
//#endregion
//#region node_modules/.pnpm/msw@2.10.2/node_modules/msw/lib/core/ws/webSocketInterceptor.mjs
const webSocketInterceptor = new WebSocketInterceptor();

//#endregion
//#region node_modules/.pnpm/msw@2.10.2/node_modules/msw/lib/core/ws/handleWebSocketEvent.mjs
function handleWebSocketEvent(options) {
	webSocketInterceptor.on("connection", async (connection) => {
		...
		await onUnhandledRequest(request, options.getUnhandledRequestStrategy()).catch((error$1) => {
...
//#endregion
//#region node_modules/.pnpm/msw@2.10.2/node_modules/msw/lib/core/ws/utils/getMessageLength.mjs
...
//#endregion
//#region node_modules/.pnpm/msw@2.10.2/node_modules/msw/lib/core/ws/utils/truncateMessage.mjs
const MAX_LENGTH = 24;
...
//#endregion
//#region node_modules/.pnpm/msw@2.10.2/node_modules/msw/lib/core/ws/utils/getPublicData.mjs
...
//#endregion
//#region node_modules/.pnpm/msw@2.10.2/node_modules/msw/lib/core/ws/utils/attachWebSocketLogger.mjs
const colors = {
	system: "#3b82f6",
	outgoing: "#22c55e",
	incoming: "#ef4444",
...
//#endregion
//#region node_modules/.pnpm/msw@2.10.2/node_modules/msw/lib/browser/index.mjs
...
function createResponseListener(context) {
	return (_, message) => {
		...
		if (responseJson.response.type?.includes("opaque")) return;
...
Please consider using a custom "serviceWorker.url" option to point to the actual worker script location, or a custom "findWorker" option to resolve the Service Worker registration manually. More details: https://mswjs.io/docs/api/setup-worker/start`, options.serviceWorker.url, location.host);
			...
			context.events.addListener(window, "beforeunload", () => {
				if (worker.state !== "redundant") context.workerChannel.send("CLIENT_CLOSED");
...
var RequestController = class {
	constructor(request) {
		...
		this[kResponsePromise] = new DeferredPromise$1();
	}
	/**
	...
	*/
	respondWith(response) {
		invariant$1.as(InterceptorError, !this[kRequestHandled], "Failed to respond to the \"%s %s\" request: the \"request\" event has already been handled.", this.request.method, this.request.url);
	...
	*/
	errorWith(reason) {
		invariant$1.as(InterceptorError, !this[kRequestHandled], "Failed to error the \"%s %s\" request: the \"request\" event has already been handled.", this.request.method, this.request.url);
		this[kRequestHandled] = true;
...
async function handleRequest2(options) {
	...
	const requestAbortPromise = new DeferredPromise$1();
...
var _FetchInterceptor = class extends Interceptor$1 {
	...
	async setup() {
		...
		invariant$1(!pureFetch[IS_PATCHED_MODULE], "Failed to patch the \"fetch\" module: already patched.");
		globalThis.fetch = async (input, init) => {
			...
			const responsePromise = new DeferredPromise$1();
...
var XMLHttpRequestController = class {
	...
	*/
	...
	get responseText() {
		invariant$1(this.request.responseType === "" || this.request.responseType === "text", "InvalidStateError: The object is in invalid state.");
	...
	get responseXML() {
		invariant$1(this.request.responseType === "" || this.request.responseType === "document", "InvalidStateError: The object is in invalid state.");
		if (this.request.readyState !== this.request.DONE) return null;
...
var _XMLHttpRequestInterceptor = class extends Interceptor$1 {
	...
	setup() {
		...
		invariant$1(!PureXMLHttpRequest[IS_PATCHED_MODULE], "Failed to patch the \"XMLHttpRequest\" module: already patched.");
...
var SetupWorkerApi = class extends SetupApi {
	...
	constructor(...handlers) {
		super(...handlers);
		invariant$1(!isNodeProcess(), devUtils.formatMessage("Failed to execute `setupWorker` in a non-browser environment. Consider using `setupServer` for Node.js environment instead."));
		this.listeners = [];
			...
			workerChannel: {
				on: (eventType, callback) => {
					this.context.events.addListener(navigator.serviceWorker, "message", (event) => {
						...
						if (!message) return;
						if (message.type === eventType) callback(event, message);
					});
				},
				send: (type) => {
				...
				once: (eventType) => {
					...
					return new Promise((resolve, reject) => {
						const handleIncomingMessage = (event) => {
							try {
								const message = event.data;
								if (message.type === eventType) resolve(message);
							} catch (error2) {
								reject(error2);
							}
						};
